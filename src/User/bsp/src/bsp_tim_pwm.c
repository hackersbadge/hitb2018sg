...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-08-16   正式发布
*		V1.1	2014-06-15   完善 bsp_SetTIMOutPWM，当占空比=0和100%时，关闭定时器，GPIO配置为输出
*		V1.2	2015-05-08   解决TIM8不能输出PWM的问题。
*		V1.3	2015-07-30   增加反相引脚输出PWM函数 bsp_SetTIMOutPWM_N();
*
